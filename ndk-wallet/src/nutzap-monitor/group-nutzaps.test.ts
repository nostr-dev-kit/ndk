...
describe("groupNutzaps", () => {
    ...
    test("should place nutzaps with different pubkey formats in different groups", () => {
        ...
        // Find each group
        const group1 = result.find(g => g.cashuPubkey === "02fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52");
        const group2 = result.find(g => g.cashuPubkey === "fa984bd7dbb282f07e16e7ae87b26a2a7b9b90b7246a44771f0cf5ae58018f52");
