...
[NDK](../README.md) / NDKAppHandlerEvent

# Class: NDKAppHandlerEvent
...
### new NDKAppHandlerEvent(ndk, rawEvent)

> **new NDKAppHandlerEvent**(`ndk`?, `rawEvent`?): [`NDKAppHandlerEvent`](NDKAppHandlerEvent.md)
...
[`NDKAppHandlerEvent`](NDKAppHandlerEvent.md)
...
[ndk/src/events/kinds/nip89/NDKAppHandler.ts:16](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/nip89/NDKAppHandler.ts#L16)
...
> **fetchProfile**(): `Promise`\<`undefined` \| [`NDKUserProfile`](../interfaces/NDKUserProfile.md)\>
...
`Promise`\<`undefined` \| [`NDKUserProfile`](../interfaces/NDKUserProfile.md)\>

#### Source

[ndk/src/events/kinds/nip89/NDKAppHandler.ts:30](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/nip89/NDKAppHandler.ts#L30)
...
> **`static`** **from**(`ndkEvent`): [`NDKAppHandlerEvent`](NDKAppHandlerEvent.md)
...
[ndk/src/events/kinds/nip89/NDKAppHandler.ts:21](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/nip89/NDKAppHandler.ts#L21)
