...
[NDK](../README.md) / NDKDVMJobResult

# Class: NDKDVMJobResult
...
### new NDKDVMJobResult(ndk, event)

> **new NDKDVMJobResult**(`ndk`?, `event`?): [`NDKDVMJobResult`](NDKDVMJobResult.md)
...
[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:11](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L11)
...
> **`get`** **jobRequest**(): `undefined` \| [`NDKEvent`](NDKEvent.md)

> **`set`** **jobRequest**(`event`): `void`

#### Parameters

• **event**: `undefined` \| [`NDKEvent`](NDKEvent.md)

#### Returns

`undefined` \| [`NDKEvent`](NDKEvent.md)

#### Source

[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:75](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L75)

***

### jobRequestId

> **`get`** **jobRequestId**(): `undefined` \| `string`
...
[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:55](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L55)

***

### result

> **`get`** **result**(): `undefined` \| `string`
...
[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:35](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L35)
...
[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:51](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L51)
...
[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:19](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L19)
...
> **`static`** **from**(`event`): [`NDKDVMJobResult`](NDKDVMJobResult.md)
...
[ndk/src/events/kinds/dvm/NDKDVMJobResult.ts:15](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMJobResult.ts#L15)
