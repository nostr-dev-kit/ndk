...
### new NDKDVMRequest(ndk, event)

> **new NDKDVMRequest**(`ndk`, `event`?): [`NDKDVMRequest`](NDKDVMRequest.md)
...
[ndk/src/events/kinds/dvm/NDKDVMRequest.ts:14](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMRequest.ts#L14)
...
> **`static`** **from**(`event`): [`NDKDVMRequest`](NDKDVMRequest.md)
...
[ndk/src/events/kinds/dvm/NDKDVMRequest.ts:22](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/dvm/NDKDVMRequest.ts#L22)
