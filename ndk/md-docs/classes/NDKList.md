...
```ts
Adding an encrypted `p` tag to the list with a "person" mark.
...
### new NDKList(ndk, rawEvent)

> **new NDKList**(`ndk`?, `rawEvent`?): [`NDKList`](NDKList.md)
...
[ndk/src/events/kinds/lists/index.ts:39](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L39)

## Properties

### \_encryptedTags

> **\_encryptedTags**: `undefined` \| [`NDKTag`](../type-aliases/NDKTag.md)[]

#### Source

[ndk/src/events/kinds/lists/index.ts:31](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L31)
...
[ndk/src/events/kinds/lists/index.ts:147](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L147)
...
> **`get`** **items**(): [`NDKTag`](../type-aliases/NDKTag.md)[]
...
[ndk/src/events/kinds/lists/index.ts:212](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L212)
...
Please use "title" instead. This method will use the `title` tag instead.
...
[ndk/src/events/kinds/lists/index.ts:101](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L101)
...
[ndk/src/events/kinds/lists/index.ts:54](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L54)

## Methods

### addItem()

> **addItem**(`item`, `mark`, `encrypted`): `Promise`\<`void`\>

Adds a new item to the list.

#### Parameters

• **item**: [`NDKTag`](../type-aliases/NDKTag.md) \| [`NDKListItem`](../type-aliases/NDKListItem.md)

• **mark**: `undefined` \| `string`= `undefined`

Optional mark to add to the item

• **encrypted**: `boolean`= `false`

Whether to encrypt the item
...
[ndk/src/events/kinds/lists/index.ts:237](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L237)
...
> **encryptedTags**(`useCache`): `Promise`\<[`NDKTag`](../type-aliases/NDKTag.md)[]\>
...
`Promise`\<[`NDKTag`](../type-aliases/NDKTag.md)[]\>

#### Source

[ndk/src/events/kinds/lists/index.ts:169](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L169)
...
> **removeItem**(`index`, `encrypted`): `Promise`\<[`NDKList`](NDKList.md)\>
...
Whether to remove from the encrypted list or not.

#### Returns

`Promise`\<[`NDKList`](NDKList.md)\>

#### Source

[ndk/src/events/kinds/lists/index.ts:287](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L287)
...
> **validateTag**(`tagValue`): `string` \| `boolean`
...
[ndk/src/events/kinds/lists/index.ts:205](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L205)
...
> **`static`** **from**(`ndkEvent`): [`NDKList`](NDKList.md)
...
[ndk/src/events/kinds/lists/index.ts:47](https://github.com/nostr-dev-kit/ndk/blob/d04eef3/ndk/src/events/kinds/lists/index.ts#L47)
