...
describe("await generateContentTags", () => {
    it("should replace valid tags and store decoded data in the tags array", async () => {
        ...
        expect(processedTags).toEqual([
            ...
            ["e", "6ab77c8baf6d0542131cc70b59ba3ece904fd58efe91d612dc3e870bdaf93034", "", "mention"],
        ]);
    });
    ...
    it("should handle existing tags and update indexes accordingly", async () => {
        const content =
            "This is a sample content with @npub1l2vyh47mk2p0qlsku7hg0vn29faehy9hy34ygaclpn66ukqp3afqutajft and @note1d2mheza0d5z5yycucu94nw37e6gyl4vwl6gavyku86rshkhexq6q30s0g7 tags.";
    ...
    it("does not replace an event without a nostr: or @ prefix", async () => {
        ...
        expect(processedTags).toEqual([
            ["e", "8c9093d06a21a5b738e9d21d907334444e7ea12258c21da333e0fc265cf92a8b", "", "mention"],
        ]);
    });
    ...
    it("handles replaceable event mentions", async () => {
        const content = "Hello world, nostr:naddr1qqrrywpn8y6rvq3qvwymuey3u7mf860ndrkw3r7dz30s0srg6tqmhtjzg7umtm6rn5eqxpqqqp65wnen4nu";
        const { content: processedContent, tags: processedTags } = await generateContentTags(content, []);
    ...
    it("uses the relay marker on naddr", async () => {
        const content = "Hello @naddr1qqrrywpn8y6rvqgdwaehxw309ahx7uewd3hkcq3qvwymuey3u7mf860ndrkw3r7dz30s0srg6tqmhtjzg7umtm6rn5eqxpqqqp65wj55zc8";
        const { content: processedContent, tags: processedTags } = await generateContentTags(content, []);
