...
export default class Nip44EncryptHandlingStrategy implements IEventHandlingStrategy {
    async handle(
...
async function encrypt(
    ...
    return await backend.signer.encrypt(recipientUser, payload, EncryptionStrategy.nip44);
}
