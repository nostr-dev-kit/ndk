<!-- @ndk-version: article-embedded-compact@0.1.0 -->
<script lang="ts">
...
<div class="article-embedded-compact">
  <ArticleCard.Root {ndk} {article}>
    <div class="article-layout">
      <ArticleCard.Image class="h-24" showGradient={true} />

      <div class="article-content">
        <ArticleCard.Title class="text-sm font-semibold" lines={1} />
