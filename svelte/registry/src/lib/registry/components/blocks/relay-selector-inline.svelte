<!-- @ndk-version: relay-selector-inline@0.1.0 -->
<!--
...
<script lang="ts">
	...
	import Root from '../relay/relay-selector-root.svelte';
	import List from '../relay/relay-selector-list.svelte';
	import AddForm from '../relay/relay-selector-add-form.svelte';
...
<Root {ndk} bind:selected {multiple}>
