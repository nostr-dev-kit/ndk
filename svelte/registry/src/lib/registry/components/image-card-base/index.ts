...
import ImageCardBase from './image-card-base.svelte';
...
export function register(renderer: ContentRenderer = defaultContentRenderer) {
	renderer.addKind(NDKImage, ImageCardBase, registration.priority);
}

// Auto-register on import
register();

export { ImageCardBase };
export default ImageCardBase;
