<script lang="ts">
	...
	import ArrowLeft from '$lib/registry/icons/arrow-left/arrow-left.svelte';
	import ArrowRight from '$lib/registry/icons/arrow-right/arrow-right.svelte';
	import ZoomIn from '$lib/registry/icons/zoom-in/zoom-in.svelte';
	import ZoomOut from '$lib/registry/icons/zoom-out/zoom-out.svelte';
	import CancelIcon from '$lib/registry/icons/cancel/cancel.svelte';
