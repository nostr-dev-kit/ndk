...
<NegentrogySync.Root {syncBuilder}>
	...
	<div data-negentropy-sync-progress-compact=""
	...
	>
		...
		{#if context.relays.length > 0}
			<div data-negentropy-sync-progress-compact="" class="flex -space-x-2 flex-shrink-0">
		...
		<!-- Status icon -->
		<div data-negentropy-sync-progress-compact="" class="flex-shrink-0">
			{#if context.syncing}
		...
		>
			<div data-negentropy-sync-progress-compact="" class="flex items-center gap-3 text-xs text-gray-600 dark:text-gray-400 whitespace-nowrap">
