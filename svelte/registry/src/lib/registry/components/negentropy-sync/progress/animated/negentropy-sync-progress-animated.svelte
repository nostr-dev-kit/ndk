<script lang="ts">
	import { NegentrogySync } from '$lib/registry/ui/negentropy-sync';
	import { createNegentropySync } from '$lib/registry/builders/negentropy-sync/index.js';
	import { getContext } from 'svelte';
	import { NEGENTROPY_SYNC_CONTEXT_KEY, type NegentropySyncContext } from '$lib/registry/ui/negentropy-sync/negentropy-sync.context.js';
