<script lang="ts">
  ...
  const sidebarClasses = $derived(
    `fixed top-14 left-0 h-[calc(100vh-3.5rem)] overflow-y-auto bg-background border-r border-border z-[900] flex flex-col transition-[width,transform] duration-300 ease-in-out ${
