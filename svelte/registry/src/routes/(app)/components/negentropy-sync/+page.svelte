<script lang="ts">
  ...
  import negentropySyncProgressMinimalCard from '$lib/registry/components/negentropy-sync-minimal/metadata.json';
  import negentropySyncProgressDetailedCard from '$lib/registry/components/negentropy-sync-detailed/metadata.json';
  import negentropySyncProgressAnimatedCard from '$lib/registry/components/negentropy-sync-animated/metadata.json';
