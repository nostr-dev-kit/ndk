...
<script lang="ts">
  ...
  import NegentropySyncProgressDetailed from '$lib/registry/components/negentropy-sync-detailed/negentropy-sync-progress-detailed.svelte';
...
<NegentropySyncProgressDetailed {syncBuilder} />
