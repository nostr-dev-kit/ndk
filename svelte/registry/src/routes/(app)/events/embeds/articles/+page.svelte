...
<div class="px-8">
  ...
  <section class="mb-12 max-w-3xl">
    ...
    <p class="text-base leading-relaxed mb-6">
      The Article embedded handler uses <code class="px-1.5 py-0.5 bg-muted/50 rounded text-sm font-mono">ArticleCard</code> primitives to display long-form content
      with rich metadata including cover images, titles, summaries, and author information.
    </p>
    <p class="text-base leading-relaxed mb-4">
      <strong class="font-semibold">Supported Kinds:</strong> 30023 (Long-form Articles / NIP-23)
    </p>
    <p class="text-base leading-relaxed mb-4">
      <strong class="font-semibold">Component:</strong> <code class="px-1.5 py-0.5 bg-muted/50 rounded text-sm font-mono">ArticleEmbedded</code>
    </p>
    <p class="text-base leading-relaxed">
      <strong class="font-semibold">Uses:</strong> <code class="px-1.5 py-0.5 bg-muted/50 rounded text-sm font-mono">ArticleCard</code> primitives
    </p>
  </section>
  ...
  <section class="mb-12">
    ...
    <div class="p-6 border border-border rounded-lg bg-card">
      ...
      <div class="p-4 bg-muted rounded font-mono text-sm space-y-2">
        ...
        <div>import ArticleCardCompact from './article-embedded-compact.svelte';</div>
        ...
        <div>compactRenderer.addKind(NDKArticle, ArticleCardCompact);</div>
        <div class="h-2"></div>
