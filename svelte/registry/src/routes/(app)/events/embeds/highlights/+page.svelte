...
<div class="px-8">
  ...
  <section class="mb-12 max-w-3xl">
    ...
    <p class="text-base leading-relaxed mb-6">
      The Highlight embedded handler uses <code class="px-1.5 py-0.5 bg-muted/50 rounded text-sm font-mono">HighlightCard</code> primitives to display highlighted
      text snippets with book-page style presentation and source attribution.
    </p>
    <p class="text-base leading-relaxed mb-4">
      <strong class="font-semibold">Supported Kinds:</strong> 9802 (Highlights / NIP-84)
    </p>
    <p class="text-base leading-relaxed mb-4">
      <strong class="font-semibold">Component:</strong> <code class="px-1.5 py-0.5 bg-muted/50 rounded text-sm font-mono">HighlightEmbedded</code>
    </p>
    <p class="text-base leading-relaxed">
      <strong class="font-semibold">Uses:</strong> <code class="px-1.5 py-0.5 bg-muted/50 rounded text-sm font-mono">HighlightCard</code> primitives
    </p>
  </section>
  ...
  <section class="mb-12">
    ...
    <div class="p-6 border border-border rounded-lg bg-card">
      ...
      <div class="p-4 bg-muted rounded font-mono text-sm space-y-2">
        ...
        <div>import HighlightCardInline from './highlight-embedded-inline.svelte';</div>
        ...
        <div>inlineRenderer.addKind(NDKHighlight, HighlightCardInline);</div>
        <div class="h-2"></div>
