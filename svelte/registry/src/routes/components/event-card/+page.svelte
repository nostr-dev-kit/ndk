<script lang="ts">
	...
	import { EventCardClassic, EventCardMenu } from '$lib/ndk/blocks';
				...
				components={[
					{
						...
						importPath: "import { EventCard } from '$lib/ndk/event-card'",
						props: [
							{
								name: 'ndk',
								type: 'NDKSvelte',
					...
					},
					{
						...
						importPath: "import { ReactionAction } from '$lib/ndk/event-card'",
						props: [
							{
								name: 'emoji',
								type: 'string',
					...
					},
					{
						...
						importPath: "import { EventCardClassic } from '$lib/ndk/blocks'",
						props: [
							{
								name: 'ndk',
								type: 'NDKSvelte',
					...
					},
					{
						...
						importPath: "import { EventCardMenu } from '$lib/ndk/blocks'",
						props: [
							{
								name: 'ndk',
								type: 'NDKSvelte',
