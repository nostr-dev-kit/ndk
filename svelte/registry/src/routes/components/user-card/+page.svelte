<script lang="ts">
	...
	import UserCardPortrait from '$lib/registry/blocks/user-card-portrait.svelte';
	import UserCardLandscape from '$lib/registry/blocks/user-card-landscape.svelte';
			...
			<ComponentAPI
				components={[
					...
					},
					{
						...
						importPath: "import { FollowButton, FollowButtonPill } from '$lib/registry/blocks'",
						props: [
							{
								name: 'ndk',
								type: 'NDKSvelte',
